...
<footer className="mt-40 ml-5">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
              {/* <div>
                  ...
                  <ul className="text-gray-600  font-medium">
                      <li className="mb-4">
                          <a href="#" className="hover:underline">{`Let's Dev India`}</a>
                      </li>
                      <li>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm sm:text-center text-gray-400">© 2023 <a href="#" className="hover:underline">{`Let's Dev India™`}</a>. All Rights Reserved.
          </span>
